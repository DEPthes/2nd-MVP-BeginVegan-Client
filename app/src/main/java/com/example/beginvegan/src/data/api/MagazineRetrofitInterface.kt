...
import com.example.beginvegan.src.data.model.magazines.Magazine
import com.example.beginvegan.src.data.model.magazines.MagazineResponse
...
interface MagazineRetrofitInterface {
    ...
    fun getMagazineRandomList(): Call<Magazine>

    // 매거진 상세 정보 조회
    @POST("/api/v1/magazines/magazine-detail")
    fun postMagazineDetail(
        @Body id: Int
    ): Call<MagazineResponse>
}