...
class HomeTodayRecipeVPAdapter(
    ...
    private var listener: HomeTodayRecipeVPAdapter.OnItemClickListener? = null
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HomeTodayRecipeVPAdapter.DataViewHolder {
        val binding =
            ItemHomeTodayRecipeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return DataViewHolder(binding)
    }

    override fun onBindViewHolder(holder: HomeTodayRecipeVPAdapter.DataViewHolder, position: Int) {
